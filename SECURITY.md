...
The repository enables Dependabot vulnerability alerts and automated security updates, secret scanning, and secret-scanning push protection. CI additionally enforces a static native-release policy, immutable third-party GitHub Action pins, dependency-lockfile installation without lifecycle scripts, SBOM generation, artifact provenance, and CodeQL JavaScript/TypeScript scanning.
