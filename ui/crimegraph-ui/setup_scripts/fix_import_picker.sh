...
echo "Patching DashboardScreen.tsx to unblock Google Drive file selection..."
...
echo "Committing..."
git commit -m "fix: unblock custom .enc extensions in Google Drive via universal file picker"

echo "Pushing to GitHub..."
git push origin main

echo "Import Picker Patch Deployed!"
