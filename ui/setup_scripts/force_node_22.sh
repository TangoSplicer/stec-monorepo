...
echo "Forcefully rewriting the GitHub Action to use Node 22..."
...
echo "Committing..."
git commit -m "ci: absolutely enforce Node.js v22"

echo "Pushing to GitHub..."
git push origin main

echo "Done! Check your Termux output above for push success."
