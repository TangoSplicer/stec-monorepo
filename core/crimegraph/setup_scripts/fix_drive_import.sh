...
echo "Patching DashboardScreen.tsx to remove fragile filename validation..."
...
echo "Committing..."
git commit -m "fix: remove fragile filename validation to support Google Drive content URIs"

echo "Pushing to GitHub..."
git push origin main

echo "Google Drive Import Patch Deployed!"
