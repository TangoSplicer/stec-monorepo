...
echo "Patching caseStore.ts to satisfy TypeScript strict null checks..."
...
echo "Committing..."
git commit -m "fix: resolve TS2345 strict null check in exportActiveCase"

echo "Pushing to GitHub..."
git push origin main

echo "Patch deployed. CI/CD pipeline should now compile cleanly."
